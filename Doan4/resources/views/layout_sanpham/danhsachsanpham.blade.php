...
<!--                                 <h6 class="widget-title border-left mb-20">Thể loại</h6>
 -->                                <div id="cat-treeview" class="product-cat">
                                    <ul>
                                        ...
                                        <li class="open"><a href="#" style="font-size: 30px">Thể loại</a>
                                            <ul>
                                                         @foreach($loaisp as $row)
                                        <li style="color: black;font-size: 17px;    cursor: -webkit-zoom-in;" onclick="Xemloai('{{$row->code}}')" class="closed">{{$row->nameLoai}}
                                        </li>
                                        @endforeach  
                                            </ul>
