   @extends('layouts.plan1')
   @section('body')
 <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" style="    width: 99px;border-radius: 50%" src="http://localhost:8000/image/logo1.png" alt="" /></a>
            </div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="index.html">
								   ...
								   <span class="mini-click-non">Danh sách loai sản phẩm</span>
								</a>
                            <ul class="submenu-angle" aria-expanded="true">
                            	@foreach($data as $item)
                                <li><a title="Dashboard v.1" href="{{route('/product/view',$item->code)}}"><span class="mini-sub-pro">{{$item->nameLoai}}</span></a></li>
                                    @endforeach
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="/product/CTHD" aria-expanded="false"><i class="icon nalika-mail icon-wrap"></i> <span class="mini-click-non">Nhập hàng</span></a>
                        </li>
                        <li>
                            <a class="has-arrow" href="/product/add" aria-expanded="false"><i class="icon nalika-mail icon-wrap"></i> <span class="mini-click-non">Thêm sản phẩm</span></a>
                        </li>
                         <li>
                            <a class="has-arrow" href="/product/hoadonnhap"  aria-expanded="false"><i class="icon nalika-mail icon-wrap"></i> <span class="mini-click-non">Hóa đơn nhập</span></a>
                        </li>
                        <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="icon nalika-diamond icon-wrap"></i> <span class="mini-click-non">Hóa đơn bán</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Google Map" href="/product/khachhang"><span class="mini-sub-pro">Khách hàng</span></a></li>
                                <li><a title="Data Maps" href="/product/hoadonban"><span class="mini-sub-pro">Hóa đơn</span></a></li>
                            </ul>
                        </li>
                           <li>
                            <a class="has-arrow" href="/product"  aria-expanded="false"><i class="icon nalika-mail icon-wrap"></i> <span class="mini-click-non">Thống kê</span></a>
                        </li>
                                <li>
                            <a class="has-arrow" href="/product/nhacungcap"  aria-expanded="false"><i class="icon nalika-mail icon-wrap"></i> <span class="mini-click-non">Nhà cung cấp</span></a>
                        </li>
     ...
     <div class="all-content-wrapper">
        ...
        <div class="header-advance-area">
            <div class="header-top-area">
                ...
                <a style="    margin-right: 132px;" href="{{url('/logout')}}"><button style="    color: aliceblue;color: black;
    font-size: 9px;" type="button" class="btn btn-outline-secondary">Logout</button></a>
                @endif
